...
class applicant
{
    /*Defining data members for storing data applicant details */
    string name;
    int age;
    string address;
    int m_sal;
...
//Function for recieving and storing loan applicants details
void applicant::get_data()
{
    ...
    cin>>p_loan;
    cout<<"NUmber of cheque bounces in last 6 months : ";
    cin>>no_chq_bounce;
        ...
        switch (ch)
        {
         case ('1'): 
         {
            ...
            case ('2'):
            {
                ...
                {
                    gotoxy(22,18);
                    cout<<"Loan applicants details not yet entered! Press any key to continue....";
                    getch();
                }
                else{
                    a.display_score();
